    ...
    function Footer() {
        return(
            <footer class="bg-[#f3f2f2] border-t">
            <div class="container px-6 py-8 mx-auto">
                <div class="flex flex-col items-center text-center">
                    <a href="#">
                        <div className="font-bold text-3xl font-custom">FUTURA</div>
                    </a>
                    ...
                    <div class="flex flex-wrap justify-center mt-6 -mx-4">
                        ...
                        <a href="#" class="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Services </a>
                        ...
                        <a href="#" class="mx-4 text-sm text-gray-600 transition-colors duration-300 hover:text-blue-500 dark:text-gray-300 dark:hover:text-blue-400" aria-label="Reddit"> Schedule a Call </a>
                    </div>
    
                </div>
    
                <hr class="my-6 border-zinc-300 md:my-10 dark:border-gray-700" />
